...
from .views import AddToBasket , DeleteBasket , GetBasket , Rent , AdminRentListAPIView , AdminGetRentObjectAPIView, EndRentAPIView,ReciveAPIView
urlpatterns = [
    ...
    path('rent/delivered/' , ReciveAPIView.as_view()),
    path('rent/end/', EndRentAPIView.as_view())
